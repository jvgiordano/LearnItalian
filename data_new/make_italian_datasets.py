...
TOPICS_BY_LEVEL: Dict[str, List[str]] = {
    ...
    "B2": [
        ...
        "Futuro anteriore",
        "Forme implicite (infinito, gerundio, participio con valore temporale/causale)",  # NEW
        ...
        "Carattere e personalità (avanzato)",  # NEW
        "Cultura",
    ...
    "C1": [
        ...
        "Filosofia e pensiero critico",  # NEW
        "Ricerca accademica",  # NEW
        "Negoziazione e diplomazia",  # NEW
...
DIFFICULT_TOPICS = {
    "Passato prossimo (reg/irr; essere/avere; accordo)",
    "Accordo del participio passato (con pronomi diretti, ne, riflessivi)",  # NEW
    "Imperfetto vs Passato prossimo",
    "Congiuntivo presente (introduzione: opinioni, emozioni base)",  # NEW
    "Congiuntivo presente",
    "Congiuntivo passato",
    "Congiuntivo imperfetto",
...
Examples:
  ...
  %(prog)s --levels A1,A2 --target 100 --batch-size 8
  %(prog)s --levels B1 --batch-size 5  # For maximum quality
        """
    )
